...
public class Vegetable_Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vegetable_details);
        ...
        view_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Vegetable_Details.this, ViewMyCart.class);
    ...
    private void checkFarmer(TextView product_name, TextView product_price, String productUnit, String productCategory, String far_id, String productImage, String productId, String custUid) {
        ...
        }else if(isEx.equals(far_id))
        {
            ...
            new SweetAlertDialog(this, SweetAlertDialog.WARNING_TYPE)
                    ...
                    .setContentText("You must complete the previous order!")
                    .setConfirmText("Ok!")
                    .show();
    ...
    private void addToemptyCard(String custUid) {
        new Database(Vegetable_Details.this).addToCart(new CustomerOrderModel(
                phone,
                productId,
                productName,
        ...
        Toast.makeText(Vegetable_Details.this, "Added to cart", Toast.LENGTH_SHORT).show();
...
//        //Toast.makeText(this, ""+isEx, Toast.LENGTH_SHORT).show();
//        if(isEx.equals("null")){
//            Toast.makeText(this, "Not"+isEx, Toast.LENGTH_SHORT).show();
//        }else
//        {
//            Toast.makeText(this, "Yes"+isEx, Toast.LENGTH_SHORT).show();
//        }
//
//
//
    ...
    public void click_farmer_data(String farmer_uid) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapterFarmerHisProducts = new AdapterHorizontalRecycler(Vegetable_Details.this, farmerProductData);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(Vegetable_Details.this, ""+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
