...
public class DFarmerDealerProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dealer_farmer_dealer_profile);
        loadLocale();
        Window w = getWindow();
...
//        ad_title1           = findViewById(R.id.title1);
//        ad_description      = findViewById(R.id.title2);
        ...
        query.addValueEventListener(new ValueEventListener() {
                ...
                for(DataSnapshot ds :snapshot.getChildren()){
                    ...
                    query.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            adapterFarmerHisProducts = new Adapter_Farmer_His_products(DFarmerDealerProfile.this, farmerProductData);
                        ...
                        public void onCancelled(@NonNull DatabaseError databaseError) {
                            ...
                            Toast.makeText(DFarmerDealerProfile.this, ""+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(DFarmerDealerProfile.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
