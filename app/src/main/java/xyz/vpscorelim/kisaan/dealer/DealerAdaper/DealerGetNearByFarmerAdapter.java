...
public class DealerGetNearByFarmerAdapter extends RecyclerView.Adapter<DealerGetNearByFarmerAdapter.MyViewHolder>{

    Context mContext;
    List<ModelFarmerData> mData;


    public DealerGetNearByFarmerAdapter(Context mContext, List<ModelFarmerData> mData) {
    ...
    @NonNull
    @Override
    public DealerGetNearByFarmerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View row = LayoutInflater.from(mContext).inflate(R.layout.dealer_list, parent, false);
        return new DealerGetNearByFarmerAdapter.MyViewHolder(row);
    }

    @Override
    public void onBindViewHolder(@NonNull DealerGetNearByFarmerAdapter.MyViewHolder holder, final int position) {

        holder.store_name.setText(mData.get(position).getFarmer_Name());
        holder.store_owner_name.setText(mData.get(position).getPhoneNumber());
        holder.shop_sub_area.setText(mData.get(position).getTehsil_Name());
        holder.shop_city.setText(mData.get(position).getDistrict_Name());
        holder.shop_state.setText(mData.get(position).getState_Name());
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    postDetailActivity.putExtra("farmerUid",mData.get(position).getUid());
