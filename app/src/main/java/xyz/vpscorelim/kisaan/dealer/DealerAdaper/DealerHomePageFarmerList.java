...
public class DealerHomePageFarmerList extends RecyclerView.Adapter<DealerHomePageFarmerList.MyViewHolder> {
    ...
    public DealerHomePageFarmerList(Context mContext, List<ModelFarmerData> mData) {
    ...
    @NonNull
    @Override
    public DealerHomePageFarmerList.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View row = LayoutInflater.from(mContext).inflate(R.layout.area_farmer,parent,false);
        return new DealerHomePageFarmerList.MyViewHolder(row);
    }


    @Override
    public void onBindViewHolder(@NonNull DealerHomePageFarmerList.MyViewHolder holder, int position) {
