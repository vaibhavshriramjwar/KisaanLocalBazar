...
import xyz.vpscorelim.kisaan.farmer.FarmerOrderDetails_Dealer;

public class FarmerOrderViewHolderDealer extends RecyclerView.Adapter<FarmerOrderViewHolderDealer.MyViewHolder> implements View.OnLongClickListener {

    Context mContext;
    List<DealerOrderRequest> mData;


    public FarmerOrderViewHolderDealer(Context mContext, List<DealerOrderRequest> mData) {
    ...
    @NonNull
    @Override
    public FarmerOrderViewHolderDealer.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View row = LayoutInflater.from(mContext).inflate(R.layout.farmer_orders_list, parent, false);
        return new FarmerOrderViewHolderDealer.MyViewHolder(row);
    }

    @Override
    public void onBindViewHolder(@NonNull FarmerOrderViewHolderDealer.MyViewHolder holder, final int position) {
        ...
        holder.take_action.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent orderDetail = new Intent(mContext, FarmerOrderDetails_Dealer.class);
