...
public class sampleAdapetr extends RecyclerView.Adapter<sampleAdapetr.MyViewHolder> {

    Context mContext;
    List<CustomerOrderModel> mData ;
    String myUid;
    FirebaseDatabase firebaseDatabase;
    DatabaseReference databaseReference ;


    public sampleAdapetr(Context mContext, List<CustomerOrderModel> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new sampleAdapetr.MyViewHolder(row);
    }
