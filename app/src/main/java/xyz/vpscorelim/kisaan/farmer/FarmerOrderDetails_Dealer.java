...
import xyz.vpscorelim.kisaan.farmer.farmer_adapter.NewAdapter;
import xyz.vpscorelim.kisaan.farmer.farmer_adapter.sampleAdapetr;

public class FarmerOrderDetails_Dealer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.farmer_order_details__dealer);
        loadLocale();
        Window w = getWindow();
        ...
        if (ContextCompat.checkSelfPermission(FarmerOrderDetails_Dealer.this, Manifest.permission.SEND_SMS)
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                orderViewHolder = new NewAdapter(FarmerOrderDetails_Dealer.this, customerRequest);
                orderLists.setAdapter(orderViewHolder);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(FarmerOrderDetails_Dealer.this, ""+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void showDialogPopup() {
        ...
        DatabaseReference ref = database.getReference("DealerToFarmerRequest");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds :snapshot.getChildren()){
                    ...
                    final String order_da                     =""+ds.child("farmer_delivery_date").getValue();
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(FarmerOrderDetails_Dealer.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog.OnDateSetListener dateSetListener=new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        new TimePickerDialog(FarmerOrderDetails_Dealer.this,timeSetListener,calendar.get(Calendar.HOUR_OF_DAY),calendar.get(Calendar.MINUTE),false).show();
                    }
                };

                new DatePickerDialog(FarmerOrderDetails_Dealer.this,dateSetListener,calendar.get(Calendar.YEAR),calendar.get(Calendar.MONTH),calendar.get(Calendar.DAY_OF_MONTH)).show();
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if(parent.getItemAtPosition(position).equals("Update Order Status"))
                {
                    ...
                    Toast.makeText(FarmerOrderDetails_Dealer.this, "You Select "+productUnit, Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void updateOrderStatus(String order_id_value, String productUnit,String order_date_far) {
        DatabaseReference ref = database.getReference("Dealer_Data");
    ...
    private void updateStatusOrder(String order_id_value, String productUnit, String customer_uid1,String order_date_far) {
        ...
        if(productUnit==null){
            ...
            result.put("farmer_delivery_date",order_date_far);
            reference.child(order_id_value).updateChildren(result)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(FarmerOrderDetails_Dealer.this, "order Status Change", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(FarmerOrderDetails_Dealer.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    private void sendSmsToCustomer(String phone, String productUnit) {
        ...
        {
            String msg="Your Grocery Status Change To "+productUnit;
            //Get the SmsManager instance and call the sendTextMessage method to send message
            SmsManager sms=SmsManager.getDefault();
            sms.sendTextMessage(phone, null, msg, null,null);
        }
        else {
            Toast.makeText(FarmerOrderDetails_Dealer.this, "Permission Denied", Toast.LENGTH_SHORT).show();
        }
    ...
    private void sendNotification(String order_id_value, String productUnit, String customer_uid1) {
        ...
        String NOTIFICATION_TYPE = "OrderStatusChangeFromFarmer";
    ...
    private void sendNotify(JSONObject notify, String order_id_value) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", notify, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(FarmerOrderDetails_Dealer.this, "Error"+error.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds :snapshot.getChildren()){
                    ...
                    //get Value
                    final String customer_name                =""+ds.child("dealer_name").getValue();
                    final String customer_phone               =""+ds.child("phone").getValue();
                    final String customer_address             =""+ds.child("address").getValue();
                    final String customer_total               =""+ds.child("total").getValue();
                    final String customer_expected_date       =""+ds.child("dealer_needed_date").getValue();
                    final String farmer_expected_delivery     =""+ds.child("farmer_delivery_date").getValue();
                    final String payment_option               =""+ds.child("payment_method").getValue();
                    final String order_status                 =""+ds.child("status").getValue();

                    order_id.setText(order_id_value);
                    order_name.setText(customer_name);
                    order_address.setText(customer_address);
                    order_phone.setText(customer_phone);
                    order_total.setText(customer_total);
                    expected_date.setText(customer_expected_date);
                    farmer_date.setText(farmer_expected_delivery);
