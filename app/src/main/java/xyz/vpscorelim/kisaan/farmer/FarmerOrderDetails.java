...
import xyz.vpscorelim.kisaan.farmer.farmer_adapter.OrderDetailAdapter;
import xyz.vpscorelim.kisaan.farmer.farmer_adapter.sampleAdapetr;

public class FarmerOrderDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.farmer_order_details);
        loadLocale();
        Window w = getWindow();
        ...
        if (ContextCompat.checkSelfPermission(FarmerOrderDetails.this, Manifest.permission.SEND_SMS)
        ...
        Toast.makeText(this, ""+phone, Toast.LENGTH_SHORT).show();
            ...
            //Get Customer Data Through his phone number
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                orderViewHolder = new sampleAdapetr(FarmerOrderDetails.this, customerRequest);
                orderLists.setAdapter(orderViewHolder);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(FarmerOrderDetails.this, ""+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void showDialogPopup() {
        ...
        DatabaseReference ref = database.getReference("RequestOrder");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(FarmerOrderDetails.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog.OnDateSetListener dateSetListener=new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        new TimePickerDialog(FarmerOrderDetails.this,timeSetListener,calendar.get(Calendar.HOUR_OF_DAY),calendar.get(Calendar.MINUTE),false).show();
                    }
                };

                new DatePickerDialog(FarmerOrderDetails.this,dateSetListener,calendar.get(Calendar.YEAR),calendar.get(Calendar.MONTH),calendar.get(Calendar.DAY_OF_MONTH)).show();
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(FarmerOrderDetails.this, "You Select "+productUnit, Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void updateOrderStatus(String order_id_value, String productUnit,String order_date_far) {
        DatabaseReference ref = database.getReference("Customer_Data");
            ...
            reference.child(order_id_value).updateChildren(result)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(FarmerOrderDetails.this, "order Status Change", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(FarmerOrderDetails.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    private void sendSmsToCustomer(String phone, String productUnit) {
        if(checkPermission(Manifest.permission.SEND_SMS))
        {
            ...
            Toast.makeText(FarmerOrderDetails.this, "Permission Denied", Toast.LENGTH_SHORT).show();
        }
    ...
    private void sendNotification(String order_id_value, String productUnit, String customer_uid1) {
        ...
        String NOTIFICATION_TYPE = "OrderStatus";
    ...
    private void sendNotify(JSONObject notify, String order_id_value) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", notify, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(FarmerOrderDetails.this, "Error"+error.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds :snapshot.getChildren()){
                    ...
                    final String customer_expected_date       =""+ds.child("customer_needed_date").getValue();
